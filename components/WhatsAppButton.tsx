...
export default function WhatsAppButton({
  ...
  const side = position === "left" ? "left-4 sm:left-5" : "right-4 sm:right-5";

  // Add safe-area inset so iPhones don't cut the button off
  const bottom = `calc(${bottomOffset}px + env(safe-area-inset-bottom))`;
  ...
  return (
    <a
      ...
      className={[
        ...
        // tighter on phones, slightly bigger on tablets+
